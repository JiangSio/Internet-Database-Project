...
<html lang="en">
  ...
  <body>
      ...
      <nav class="navbar navbar-expand-lg fixed-top scrolling-navbar indigo">
        <div class="container">
          ...
          <div class="collapse navbar-collapse" id="main-navbar">
            <ul class="navbar-nav mr-auto w-100 justify-content-end">
              ...
              <li class="nav-item">
                <a class="nav-link page-scroll" href="#services">News</a>
              </li>
              <li class="nav-item">
                <a class="nav-link page-scroll" href="#features">Focus</a>
              </li>
              <li class="nav-item">
                <a class="nav-link page-scroll" href="#portfolios">Analysis</a>
              </li>
              <li class="nav-item">
                <a class="nav-link page-scroll" href="#pricing">Overview</a>
              </li>
              <li class="nav-item">
        ...
        <ul class="mobile-menu">
           <li>
            ...
            <li>
              <a class="page-scroll" href="#features">Focus</a>
            </li>
            <li>
              <a class="page-scroll" href="#portfolios">Analysis</a>
            </li>
            <li>
              <a class="page-scroll" href="#pricing">Overview</a>
            </li>
            <li>
    ...
    <section id="services" class="section">
      <div class="container">
        <div class="section-header">          
          <h2 class="section-title wow fadeIn" data-wow-duration="1000ms" data-wow-delay="0.3s">新闻报道</h2>
          <hr class="lines wow zoomIn" data-wow-delay="0.3s">
          <p class="section-subtitle wow fadeIn" data-wow-duration="1000ms" data-wow-delay="0.3s">俄乌战持续长达一年<br>为当地民众带来深重灾难</p>
        </div>
        <div class="row">
          <div class="col-md-4 col-sm-6" onclick="window.open('index.php?r=news/index')">
    ...
    <div id="pricing" class="section pricing-section">
      <div class="container" >
        <div class="section-header">          
          <h2 class="section-title">战争概况</h2>
          <hr class="lines">
          <p class="section-subtitle">整体局势揭晓 <br> 战火中百姓的艰难岁月</p>
        </div>
          ...
          <div class="col-md-4 col-sm-6 col-xs-12">
            <div class="pricing-table">
              ...
              <div class="plan-button">
                <a href="index.php?r=xw/index" class="btn btn-common">Get Now</a>
              </div>
            </div>
          </div>
